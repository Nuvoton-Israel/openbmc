...
SRC_URI:append = " file://0008-i3c-master-svc-set-MCONFIG.HKEEP-to-3.patch"
SRC_URI:append = " file://0009-i3c-master-svc-add-check-ibi-request-capable-bit-whe.patch"
SRC_URI:append = " file://0010-i3c-master-svc-remove-wait-i3c-bus-idle-after-emit-s.patch"
SRC_URI:append = " file://0011-i3c-master-svc-fix-timing-issue-during-DAA.patch"
SRC_URI:append = " file://0012-i3c-master-svc-fix-IBI-issue.patch"
SRC_URI:append = " file://0013-i3c-master-svc-fix-invalid-SlvStart-event.patch"
